...
public class Paging implements Serializable
{
	...
	private void pagingProc()
	{
		...
		if(curBlock < totalBlock)
		{
		 ...
		 System.out.println("[Paging] totalPage : " + totalPage + ", startNum : " + startNum + ", totalBlock : " + totalBlock + 
		            ", curBlock : " + curBlock + ", startPage : " + startPage + ", endPage : " + endPage + ", startRow : " + startRow + 
		            ", endRow : " + endRow);
		      
		      System.out.println("prevBlockPage : " + prevBlockPage + ", nextBlockPage : " + nextBlockPage);
	}
}
